...
-- infect_throat_12m
-- One year follow-up
-- Number of throat-coded GP event rows from adult patients during trial period.
------------
...
INSERT INTO PerPracticeData (prac_code, prac_name, region, infect_throat_12m)
SELECT
    prac_code,
    prac_name,
    region,
    COUNT(*) AS infect_throat_12m
FROM adult_patients
GROUP BY
    prac_code,
    prac_name,
