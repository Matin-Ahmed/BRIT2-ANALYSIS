...
-- sex_m_uti 
-- Trial Period  
-- Number of male adult patients with incident UTI during trial period
--------------------
...
INSERT INTO PerPracticeData(prac_code,prac_name,region,sex_m_uti)
  SELECT
    prac_code,
    prac_name,
    region,
    COUNT(PK_Patient_ID) AS sex_m_uti
  FROM adult_patients
