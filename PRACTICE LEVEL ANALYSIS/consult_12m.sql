------------
--consult_12m One year follow-up  Number of consultations for adult patients with common infections during trial period.
------------
...
INSERT INTO PerPracticeData(prac_code,prac_name,region,consult_12m)
  SELECT
    prac_code,
    prac_name,
    region,
    COUNT(FK_Patient_Link_ID) AS consult_12m
  FROM adult_patients
