...
-- all_pats_12m  
-- One year follow-up  
-- Total number of all registered patients in GP practice from final data extract.
--------------------
...
INSERT INTO PerPracticeData(prac_code,prac_name,region,all_pats_12m)
SELECT
prac_code,
prac_name,
region,
COUNT(DISTINCT PK_Patient_ID) AS all_pats_12m
FROM adult_patients
