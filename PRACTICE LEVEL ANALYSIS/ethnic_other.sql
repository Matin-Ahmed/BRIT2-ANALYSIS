...
-- ethnic_other 
-- Baseline 
-- Number of adult patients of other ethnicity
--------------------
WITH patient_ages AS (
  ...
  WHERE EthnicMainGroup = 'Other Ethnic Groups'
),
adult_patients AS (
  SELECT *
  FROM patient_ages
...
INSERT INTO PerPracticeData(prac_code,prac_name,region,ethnic_other)
  SELECT
    prac_code,
    prac_name,
    region,
    COUNT(DISTINCT PK_Patient_ID) AS ethnic_other
  FROM adult_patients
