...
-- sex_male_ci 
-- Baseline  
-- Number of male adult patients with a common infection.
--------------------
...
INSERT INTO PerPracticeData(prac_code,prac_name,region,sex_male_ci)
  SELECT
    prac_code,
    prac_name,
    region,
    COUNT(PK_Patient_ID) AS sex_male_ci
  FROM adult_patients
