...
-- age_num_ci  
-- Baseline  
-- Number of adult patients with a common infection and where date of birth was given.
--------------------
...
INSERT INTO PerPracticeData(prac_code,prac_name,region,age_num_ci)
  SELECT
    prac_code,
    prac_name,
    region,
    COUNT(PK_Patient_ID) AS age_num_ci
  FROM adult_patients
