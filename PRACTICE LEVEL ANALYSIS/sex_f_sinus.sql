...
--  sex_f_sinus 
-- trial period  
-- Number of female adult patients with incident sinusitits during trial period
--------------------
...
INSERT INTO PerPracticeData(prac_code,prac_name,region,sex_f_sinus)
  SELECT
    prac_code,
    prac_name,
    region,
    COUNT(PK_Patient_ID) AS sex_f_sinus
  FROM adult_patients
