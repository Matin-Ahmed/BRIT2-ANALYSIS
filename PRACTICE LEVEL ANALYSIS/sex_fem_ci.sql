...
-- sex_fem_ci  
-- Baseline  
-- Number of female adult patients with a common infection.
--------------------
...
INSERT INTO PerPracticeData(prac_code,prac_name,region,sex_fem_ci)
  SELECT
    prac_code,
    prac_name,
    region,
    COUNT(PK_Patient_ID) AS sex_fem_ci
  FROM adult_patients
