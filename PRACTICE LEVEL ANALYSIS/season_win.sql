...
-- season_win 
-- One year follow-up 
-- Number of prescriptions for adult patients during Winter 2024/5 (21 Dec 2024 to 19 Mar 2025).
------------
...
INSERT INTO PerPracticeData(prac_code,prac_name,region,season_win)
  SELECT
    prac_code,
    prac_name,
    region,
    PERS_COUNT AS season_win
  FROM adult_patients
;
