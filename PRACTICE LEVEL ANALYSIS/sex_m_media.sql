...
-- sex_m_media 
-- Trial period  
-- Number of male adult patients with incident otitis media during trial period
--------------------
...
INSERT INTO PerPracticeData(prac_code,prac_name,region,sex_m_media)
  SELECT
    prac_code,
    prac_name,
    region,
    COUNT(PK_Patient_ID) AS sex_m_media
  FROM adult_patients
