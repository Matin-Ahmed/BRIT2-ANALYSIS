--------------------
--imd_aff Baseline  Number of adult patients from affluent areas  (Rankings from 19707 to 26275)
--------------------
...
adult_patients AS (
  SELECT *
  FROM patient_ages P
  WHERE age >= 18 AND IMD_Score BETWEEN 19707 AND 26275
)
INSERT INTO PerPracticeData(prac_code,prac_name,region,imd_aff)
  SELECT 
    prac_code,prac_name,region,
    COUNT(DISTINCT PK_Patient_ID) AS imd_aff
  FROM adult_patients
