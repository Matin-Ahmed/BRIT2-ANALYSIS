------------
--infect_uti_bl Baseline  Number of incident UTIs from adult patients during baseline year. 
------------
...
INSERT INTO PerPracticeData(prac_code,prac_name,region,infect_uti_bl)
  SELECT
    prac_code,
    prac_name,
    region,
    COUNT(FK_Patient_Link_ID) AS infect_uti_bl
  FROM adult_patients
