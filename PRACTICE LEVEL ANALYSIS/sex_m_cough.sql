...
-- sex_m_cough 
-- Trial period  
-- Number of male adult patients with incident cough during trial period
--------------------
...
INSERT INTO PerPracticeData(prac_code,prac_name,region,sex_m_cough)
  SELECT
    prac_code,
    prac_name,
    region,
    COUNT(PK_Patient_ID) AS sex_m_cough
  FROM adult_patients
