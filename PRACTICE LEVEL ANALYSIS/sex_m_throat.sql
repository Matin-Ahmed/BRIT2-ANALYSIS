...
-- sex_m_throat  
-- Trial period  
-- Number of male adult patients with incident sore throat during trial period
--------------------
...
INSERT INTO PerPracticeData(prac_code,prac_name,region,sex_m_throat)
  SELECT
    prac_code,
    prac_name,
    region,
    COUNT(PK_Patient_ID) AS sex_m_throat
  FROM adult_patients
