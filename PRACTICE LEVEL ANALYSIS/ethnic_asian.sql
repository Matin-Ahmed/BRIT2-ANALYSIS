...
-- ethnic_asian 
-- Baseline 
-- Number of adult patients of asian ethnicity
--------------------
...
WITH patient_ages AS (
  ...
  WHERE EthnicMainGroup = 'Asian or Asian British'
),
adult_patients AS (
  SELECT *
  FROM patient_ages
...
INSERT INTO PerPracticeData(prac_code,prac_name,region,ethnic_asian)
  SELECT
    prac_code,
    prac_name,
    region,
    COUNT(DISTINCT PK_Patient_ID) AS ethnic_asian
  FROM adult_patients
