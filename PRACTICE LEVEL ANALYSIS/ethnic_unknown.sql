...
-- ethnic_unknown 
-- Baseline 
-- Number of adult patients with missing or 'refused and not stated' ethnic group
--------------------
...
INSERT INTO PerPracticeData(prac_code,prac_name,region,ethnic_unknown)
  SELECT
    prac_code,
    prac_name,
    region,
    COUNT(DISTINCT PK_Patient_ID) AS ethnic_unknown
  FROM adult_patients
