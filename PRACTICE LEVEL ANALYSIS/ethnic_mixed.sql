...
-- ethnic_mixed 
-- Baseline 
-- Number of adult patients of mixed ethnicity
--------------------
...
WITH patient_ages AS (
  ...
  WHERE EthnicMainGroup = 'Mixed or multiple ethnic groups'
),
adult_patients AS (
  SELECT *
  FROM patient_ages
...
INSERT INTO PerPracticeData(prac_code,prac_name,region,ethnic_mixed)
  SELECT
    prac_code,
    prac_name,
    region,
    COUNT(DISTINCT PK_Patient_ID) AS ethnic_mixed
  FROM adult_patients
