--------------------
--imd_most_aff  Baseline  Number of adult patients from most affluent areas  (Rankings from 26276 to 32844)
--------------------
...
adult_patients AS (
  SELECT *
  FROM patient_ages P
  WHERE age >= 18 AND IMD_Score BETWEEN 26276 AND 32844
)
INSERT INTO PerPracticeData(prac_code,prac_name,region,imd_most_aff)
  SELECT 
    prac_code,prac_name,region,
    COUNT(DISTINCT PK_Patient_ID) AS imd_most_aff
  FROM adult_patients
