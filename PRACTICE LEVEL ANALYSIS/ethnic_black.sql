...
-- ethnic_black 
-- Baseline 
-- Number of adult patients of black ethnicity
--------------------
...
WITH patient_ages AS (
  ...
  WHERE EthnicMainGroup = 'Black, Black British, Caribbean or African'
),
adult_patients AS (
  SELECT *
  FROM patient_ages
...
INSERT INTO PerPracticeData(prac_code,prac_name,region,ethnic_black)
  SELECT
    prac_code,
    prac_name,
    region,
    COUNT(DISTINCT PK_Patient_ID) AS ethnic_black
  FROM adult_patients
