...
-- age_mean_ci 
-- Baseline  
-- Mean age (years) of adult patients from GP practice with a common infection.
--------------------
...
INSERT INTO PerPracticeData(prac_code,prac_name,region,age_mean_ci)
  SELECT
    prac_code,
    prac_name,
    region,
    AVG(age) AS age_mean_ci
  FROM adult_patients
