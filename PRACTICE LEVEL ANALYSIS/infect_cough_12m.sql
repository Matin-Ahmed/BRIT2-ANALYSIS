...
-- infect_cough_12m
-- One year follow-up
-- Number of cough-coded GP event rows from adult patients during trial period.
------------
...
INSERT INTO PerPracticeData (prac_code, prac_name, region, infect_cough_12m)
SELECT
    prac_code,
    prac_name,
    region,
    COUNT(*) AS infect_cough_12m
FROM adult_patients
GROUP BY
    prac_code,
    prac_name,
