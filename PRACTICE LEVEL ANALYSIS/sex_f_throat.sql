...
-- sex_f_throat  
-- Trial period  
-- Number of female adult patients with incident sore throat during trial period
--------------------
...
INSERT INTO PerPracticeData(prac_code,prac_name,region,sex_f_throat)
  SELECT
    prac_code,
    prac_name,
    region,
    COUNT(PK_Patient_ID) AS sex_f_throat
  FROM adult_patients
