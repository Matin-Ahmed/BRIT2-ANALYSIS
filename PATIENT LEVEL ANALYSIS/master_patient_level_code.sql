...
-- DROP OLD TABLES
------------------------------------------------------------
IF OBJECT_ID('[BRIT].[PatientLevelData]', 'U') IS NOT NULL DROP TABLE [BRIT].[PatientLevelData];
IF OBJECT_ID('[BRIT].[PatientLevelDataFinal]', 'U') IS NOT NULL DROP TABLE [BRIT].[PatientLevelDataFinal];

------------------------------------------------------------
-- CREATE PatientLevelData (MASTER TABLE)
------------------------------------------------------------
CREATE TABLE [BRIT].[PatientLevelData] (
...
------------------------------------------------------------
SELECT *
INTO [BRIT].[PatientLevelDataFinal]
...
------------------------------------------------------------
-- APPLY 14-DAY RULE (incident events)
...
INNER JOIN flu_flag ff
    ON ff.Patient_ID = [BRIT].[PatientLevelData].Patient_ID
   AND ff.infect = [BRIT].[PatientLevelData].infect
   AND ff.event_date = [BRIT].[PatientLevelData].event_date;
...
------------------------------------------------------------
-- POPULATE PatientLevelDataFinal
------------------------------------------------------------

INSERT INTO [BRIT].[PatientLevelDataFinal]
SELECT *
FROM [BRIT].[PatientLevelData];
